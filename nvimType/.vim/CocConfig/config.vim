...
xmap <C-e>f  <Plug>(coc-format-selected)<CR>
nnoremap <C-e>f  <Plug>(coc-format-selected)<CR>
...
xmap <leader>a  v<Plug>(coc-codeaction-selected)<CR>
nmap <leader>a  v<Plug>(coc-codeaction-selected)<CR>
